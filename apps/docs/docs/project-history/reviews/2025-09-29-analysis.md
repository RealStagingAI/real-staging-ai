...
- **Docs**
  ...
  - GitHub Pages is live: https://api.real-staging-ai/api/v1/docs/
...
- **P1 — Docs & CI**
  - Pages is live (https://api.real-staging-ai/api/v1/docs/); add docs link in repo description; finish OTEL guide (`docs/roadmap/phase1/OBSERVABILITY.md`).
