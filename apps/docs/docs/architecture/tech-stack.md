...
- S3-compatible API
- Significantly cheaper than AWS S3 ($0.005/GB vs $0.023/GB)
- Generous free egress (3x storage)
- No per-request fees for most operations
- Presigned URLs for direct uploads
- High durability and availability

**Cost Comparison (1TB storage, moderate usage):**
...
**Compute & Database: Render**

- API & Worker services
- PostgreSQL database
- Redis cache
- Cost: ~$31/month (starter tier)
- Zero DevOps, automatic SSL, monitoring included
